...
const loadPerformanceData = useCallback(async () => {
  ...
  try {
    ...
    const insightsResponse = await axios.get(
      `https://graph.facebook.com/v18.0/act_${formattedAccountId}/insights`,
      {
        params: {
    ...
    const campaignsResponse = await axios.get(
      `https://graph.facebook.com/v18.0/act_${formattedAccountId}/campaigns`,
      {
        params: {
          access_token: accessToken,
    ...
    const adsResponse = await axios.get(
      `https://graph.facebook.com/v18.0/act_${formattedAccountId}/ads`,
      {
        params: {
          access_token: accessToken,
